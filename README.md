(see the assignment description at the "# Receipt Processor" section)
# Build:
  docker build -t alextenishev/receipt-processor-challedge .
# Run
  docker run -d -p 127.0.0.1:80:3000 alextenishev/receipt-processor-challedge
